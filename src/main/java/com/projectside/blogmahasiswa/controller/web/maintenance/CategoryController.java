...
//
//    @PostMapping("/save")
//    public ModelAndView save(@ModelAttribute Category category, ModelMap model) {
...
//        return new ModelAndView("redirect:/category/detail/" + categoryDto.getId().toString(), model);
//    }
//
//    @GetMapping("/list")
...
//    public ModelAndView deleteCategory(@PathVariable String id, ModelMap model) {
